...
public class dateDemo extends javax.swing.JFrame {
     ...
     */
        ...
        DataInter dao = DataImple.getDataImple();
        List<DataDTO> list = dao.getCal();
        ...
        for(DataDTO rs : list){
                ...
                sb.append("Sysdate : ").append(rs.getSysdate()).append(" ");
                sb.append("근무일수 : ").append(rs.getDuringWork()).append(" 일  \n");
